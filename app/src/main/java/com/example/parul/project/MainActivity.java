...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    private static final Integer[] XMEN= {R.drawable.gandhi,R.drawable.sukhna_lake,R.drawable.rock_garden,R.drawable.sukhna_lake,R.drawable.gandhi};
  ...
  //function for image slider
    ...
    public void News(View v) {
        ...
        Intent intentToNews =  new Intent(this,libraryHome.class);
    ...
    public void Notification(View v) {
        ...
        Intent intentToNotify =  new Intent(this,libraryHome.class);
